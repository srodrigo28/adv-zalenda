  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="flex flex-col items-center session-2 p-20" 
        style={{ backgroundImage: `url("./image/page2.png")`, 
      ...
      <section className="flex items-center">
          ...
          <div
           style={{ backgroundImage: `url("./image/contato-left.png")`, 
          ...
          <div
          style={{ backgroundImage: `url("./image/contato-right.png")`, 
            width: '50%', height: '100vh', backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>

            <div>
              <div className="row">
                <h3>E-mail</h3>
                <p>zalendaadvogados@gmail.com</p>
              </div>
